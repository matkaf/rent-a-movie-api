...
const validateData = (movies) => {
    const data = movies.map((movie) => {
        return Object.assign(Object.assign({}, movie), { returnDate: setReturnDate() });
    });
    return data;
};
const createMovieRental = (movies) => __awaiter(void 0, void 0, void 0, function* () {
    const data = validateData(movies);
    try {
        const res = yield prismaClient_1.default.movieRental.createMany({ data, skipDuplicates: true });
